...
```{r, echo=FALSE}
topic_col <- c(
  "Intro to Urban Analytics in R (Slide), Intro to R - 1 (RMD)",# 1
  "Modern urban data vs. conventional data (Slide), Intro to R - 2 (RMD)",# 2
  "Accessing data (Slide), Census API (RMD), Yelp API (RMD)",# 3
  "Tidy data (Slide), Data wrangling (RMD)",# 4
  "First insights from your data - Stats (Slide), Hands-on (RMD)",# 5
  "Interactive visualization (Slide), Hands-on (RMD)",# 6
  "Intro to GTFS (Slide), [GTFS and equity](./Lab/module_2/1_GTFS.html)",# 7
  "Intro to OSM (Slide), [OSM as a graph](./Lab/module_2/2_OSM.html)",# 8
  "Images and computer vision - 1",# 9
  "Images and computer vision - 2",# 10
  "What people are twitting about our cities - 1",# 11
  "What people are twitting about our cities - 2",# 12
  "Storytelling with data",# 13
  "Storytelling with data",# 14
  "Student presentations",# 15
  "Student presentations",# 16
  "Dead week"# 17
)
...
assignment_col <- c(
  "",# 1
  "",# 2
  "[Mini-1](https://rpubs.com/spring19cp6521/Syllabus), <br> [Mini-2]()",# 3
  "[Mini-1](), <br> [Mini-2]()",# 4
  "",# 5
  "",# 6
  "",# 7
