...
```{r, echo=FALSE}
topic_col <- c(
  "Intro to Urban Analytics in R [(Slide)](https://github.gatech.edu/pages/sguhathakurta3/UA-Lecture1/Untitled/LectureONE.html), <br> Data ethics [(Slide)](https://github.gatech.edu/pages/sguhathakurta3/UA-Lecture1/Lecture-2/LectureTWO.html)",# 1
  ...
  "Accessing data [(Slide)](https://bonwookoo.github.io/UrbanAnalytics2022/Lab/module_1/Module1_Yelp_Census_Slide.html), <br> 
  Census & Yelp API [(RMD)](https://bonwookoo.github.io/UrbanAnalytics2022/Lab/module_1/Module1_Yelp_Census.html), <br>Creating sf objects [(Slide)](https://bonwookoo.github.io/UrbanAnalytics2022/Lab/module_1/Module1_Yelp_Census_Slide_additional.html)",# 3
  "<b>(Tue) Mini-presentation 1 (Slide)</b>, <br> Tidy data (Slide), <br> Data wrangling (RMD)",# 4
  "First statistical insights from your data (Slide), <br> Hands-on (RMD)",# 5
  "Interactive visualization (Slide), <br> Hands-on (RMD)",# 6
  "<b>(Tue) Mini-presentation 2 (Slide)</b>, <br> General Transit Feed Specification (Slide), <br> GTFS and equity (RMD)",# 7 # [GTFS and equity (RMD)](./Lab/module_2/1_GTFS.html)
  "Open Street Map (Slide), <br> OSM as a graph (RMD)",# 8 # [OSM as a graph (RMD)](./Lab/module_2/2_OSM.html)
  "<b>(Tue) Mini-presentation 3 (Slide)</b>, Urban images and computer vision (Slide), <br> Yolo in R (RMD)",# 9
  "Many ways of viewing your city (Slide), <br> Sampling images and running Mask R-CNN on Google Colab (RMD)",# 10
  "<b>(Tue) Mini-presentation 4 (Slide)</b>, <br> User-generated text data - Twitter (Slide), <br> Getting live feeds from Twitter (RMD)",# 11
  "Preprocessing texts (Slide), <br> Sentiment analysis (RMD)",# 12
  "<b>(Tue) Mini-presentation 5 (Slide)</b>, <br> Storytelling with data - 1",# 13
  "Storytelling with data - 2",# 14
  "<b>Student presentations</b>",# 15
  "<b>Student presentations - continued</b>",# 16
  "Wrap up"# 17
)

reading_col <- c(
  "[Tu](https://journals.sagepub.com/doi/full/10.1177/2399808319839494) <br> [Th-1](https://scholarship.law.gwu.edu/cgi/viewcontent.cgi?article=1159&context=faculty_publications), [Th-2](https://openyls.law.yale.edu/handle/20.500.13051/7808), [Th-3](https://web.stanford.edu/dept/HPS/Design%20AI%20so%20that%20it%27s%20fair.pdf), [Th-4](https://www.nature.com/articles/541458a)",# 1
  "[Tu-1](https://r4ds.had.co.nz/workflow-basics.html), [Tu-2](https://r4ds.had.co.nz/transform.html) <br>
   [Th-1](https://geocompr.robinlovelace.net/spatial-class.html), [Th-2](https://geocompr.robinlovelace.net/attr.html), [Th-3](https://geocompr.robinlovelace.net/spatial-operations.html), [Th-4](https://rmarkdown.rstudio.com/lesson-1.html)",# 2
  "[1](https://dl.acm.org/doi/abs/10.1145/3152178.3152181?casa_token=TKWejCaCUvgAAAAA:B78bsMo0gT6t2GSsl1MQWAIsXs0BCG6usrW5fwpKPYhorO0lKTpXNHUmPQQ0y4xeJYC3U5CF08hjIA), [2](https://www.nber.org/system/files/working_papers/w24952/w24952.pdf), [3](https://bonwookoo.github.io/UrbanAnalytics2022/Lab/module_1/manuscript.pdf)",# 3
...
assignment_col <- c(
  ...
  "",# 2
  "[Mini](https://bonwookoo.github.io/UrbanAnalytics2022/Assignment/mini_1/mini_assignment_1.html)",# 3
  "Mini",# 4 # add 
  "Mini",# 5
  "Mini",# 6
  "",# 7
