...
topic_col <- c(
  ...
  "<b>Mini-presentation (Slide)</b>, Accessing data (Slide), <br> Census & Yelp API (RMD)",# 3
  ...
  "<b>Mini-presentation (Slide)</b>, General Transit Feed Specification (Slide), <br> GTFS and equity (RMD)",# 7 # [GTFS and equity (RMD)](./Lab/module_2/1_GTFS.html)
  ...
  "<b>Mini-presentation (Slide)</b>, User-generated text data - Twitter (Slide), <br> Getting live feeds from Twitter (RMD)",# 11
  "Preprocessing texts (Slide), <br> Sentiment analysis (RMD)",# 12
  "<b>Mini-presentation (Slide)</b>, Storytelling with data - 1",# 13
