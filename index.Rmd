...
topic_col <- c(
  ...
  "<b>Mini-presentation (Slide)</b>, <br> Accessing data (Slide), <br> Census & Yelp API (RMD)",# 3
  ...
  "<b>Mini-presentation (Slide)</b>, <br> General Transit Feed Specification (Slide), <br> GTFS and equity (RMD)",# 7 # [GTFS and equity (RMD)](./Lab/module_2/1_GTFS.html)
  "Open Street Map (Slide), <br> OSM as a graph (RMD)",# 8 # [OSM as a graph (RMD)](./Lab/module_2/2_OSM.html)
  "<b>Mini-presentation (Slide)</b>, Urban images and computer vision (Slide), <br> Yolo in R (RMD)",# 9
  "Many ways of viewing your city (Slide), <br> Sampling images and using Vision API (RMD)",# 10
  "<b>Mini-presentation (Slide)</b>, <br> User-generated text data - Twitter (Slide), <br> Getting live feeds from Twitter (RMD)",# 11
  "Preprocessing texts (Slide), <br> Sentiment analysis (RMD)",# 12
  "<b>Mini-presentation (Slide)</b>, <br> Storytelling with data - 1",# 13
...
reading_col <- c(
  "[TU](https://journals.sagepub.com/doi/full/10.1177/2399808319839494) <br> 
  [TH-1](https://r4ds.had.co.nz/workflow-basics.html), [TH-2](https://r4ds.had.co.nz/transform.html)",# 1
  "",# 2
  "",# 3
  "",# 4 
