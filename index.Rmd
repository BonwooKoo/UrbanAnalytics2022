...
topic_col <- c(
  ...
  "Accessing data [(Slide)](https://bonwookoo.github.io/UrbanAnalytics2022/Lab/module_1/Module1_Yelp_Census_Slide.html), <br> Census & Yelp API [(RMD)](https://bonwookoo.github.io/UrbanAnalytics2022/Lab/module_1/Module1_Yelp_Census.html)",# 3
  "<b>Mini-presentation 1 (Slide)</b>, <br> Tidy data (Slide), <br> Data wrangling (RMD)",# 4
  "First statistical insights from your data (Slide), <br> Hands-on (RMD)",# 5
  "Interactive visualization (Slide), <br> Hands-on (RMD)",# 6
  "<b>Mini-presentation 2 (Slide)</b>, <br> General Transit Feed Specification (Slide), <br> GTFS and equity (RMD)",# 7 # [GTFS and equity (RMD)](./Lab/module_2/1_GTFS.html)
  "Open Street Map (Slide), <br> OSM as a graph (RMD)",# 8 # [OSM as a graph (RMD)](./Lab/module_2/2_OSM.html)
  "<b>Mini-presentation 3 (Slide)</b>, Urban images and computer vision (Slide), <br> Yolo in R (RMD)",# 9
  "Many ways of viewing your city (Slide), <br> Sampling images and running Mask R-CNN on Google Colab (RMD)",# 10
  "<b>Mini-presentation 4 (Slide)</b>, <br> User-generated text data - Twitter (Slide), <br> Getting live feeds from Twitter (RMD)",# 11
  "Preprocessing texts (Slide), <br> Sentiment analysis (RMD)",# 12
  "<b>Mini-presentation 5 (Slide)</b>, <br> Storytelling with data - 1",# 13
