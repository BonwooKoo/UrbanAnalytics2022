...
```{r, echo=FALSE}
topic_col <- c(
  "Intro to Urban Analytics in R [(Slide)](https://github.gatech.edu/pages/sguhathakurta3/UA-Lectures/Lecture-1/LectureONE.html#1), <br> Data ethics [(Slide)](https://github.gatech.edu/pages/sguhathakurta3/UA-Lectures/Lecture-2/LectureTWO.html#1)",# 1
