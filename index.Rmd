...
topic_col <- c(
  ...
  "Data for Urban Analytics (Slide), <br> Intro to R - 2 (RMD), Guest lecture",# 2
  ...
  "General Transit Feed Specification (Slide), <br> GTFS and equity (RMD)",# 7 # [GTFS and equity (RMD)](./Lab/module_2/1_GTFS.html)
...
```{r echo=F}
data.frame('Assignment Type' = c("Final project", 'Major assignment', 'Mini assignment', "Participation"),
           'Percent' = c("20%", "45% (15% each x 3)", "30% (10% each x 3)", "5%")) %>% 
  kbl() %>% 
