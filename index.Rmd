...
weeks <- tibble(
  ...
  mutate(Week = case_when(Week %in% guha ~ paste0(Week, "<br> <font size=3 color=gray>Guhathakurta</font>"),
                          Week %in% koo ~ paste0(Week, "<br> <font size=3 color=gray>Koo</font>"),
                          TRUE ~ Week))
```
...
topic_col <- c(
  ...
  "<b>(Tue) Mini-presentation 2 (Slide)</b>, <br> General Transit Feed Specification [(RMD)](https://bonwookoo.github.io/UrbanAnalytics2022/Lab/module_2/1_GTFS_v2.html)",# 7 # [GTFS and equity (RMD)](./Lab/module_2/1_GTFS.html)
