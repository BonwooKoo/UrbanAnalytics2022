...
topic_col <- c(
  ...
  "Data for Urban Analytics (Slide), <br> Intro to R - 1 [(Slide)](./Lab/module_0/w2_d1_Intro_to_R_1.html), 2 [(Slide)](./Lab/module_0/w2_d2_Intro_to_R_2.html)",# 2
...
reading_col <- c(
  ...
  "",# 3
  "",# 4 
        # [1]https://r4ds.had.co.nz/tidy-data.html, [2](https://r4ds.had.co.nz/transform.html)
  "",# 5
  "",# 6
  "",# 7
  "",# 8
