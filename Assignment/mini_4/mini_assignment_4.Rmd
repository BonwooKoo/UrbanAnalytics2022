...
1. Download the data prepared for this assignment from [here](https://bonwookoo.github.io/UrbanAnalytics2022/Assignment/mini_4/yelp_coffee.rds). This data was prepared using the following steps:
    ...
    * The two data are spatially joined. After joining, a few additional columns were generated, including 
        (1) the number of businesses (yelp_n)
        (2) average rating (avg_rating)
        (3) number of reviews (review_count)
        (4) log of the number of reviews (review_count_log)
