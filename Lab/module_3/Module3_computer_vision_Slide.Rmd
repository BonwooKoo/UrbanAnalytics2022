...
* The (urban) built environment has been measured using e.g., residential density, street connectivity, land use mix, distance to transit, Walk Score, etc. 
...
https://maps.googleapis.com/maps/api/streetview?size=640x640&location=33.7768249,-84.388767&heading=224.96&fov=90&pitch=0&key=YOUR_API_KEY
