...
.mid[
Reading SHP and JSON files are no different, except you need some packages.
]

Notice that we are reading GEOJSON rather than SHP -- they are essentially the same data in different formats.
