...
Sample data: [CSV](https://raw.githubusercontent.com/BonwooKoo/UrbanAnalytics2022/main/Lab/module_0/testdata.csv), SHP(), [JSON](https://raw.githubusercontent.com/BonwooKoo/UrbanAnalytics2022/main/Lab/module_0/testdata.json)


```{r eval=F}
# CSV files
library(tidyverse)
df <- readr::read_csv("file-name.csv") # or
...
filter(my_df, # specifies which data.frame
  ...
  nice_table("150px") # ignore this nice_table() for now.
```
