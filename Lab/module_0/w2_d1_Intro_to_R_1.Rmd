...
* However, we have virtual machines (VMs) for this class, in which *most of the required packages and applications are pre-installed*.
...
---
## Setting Environment
When you open R Studio, R is **in** one of the folders in your computer. It looks for files and saves output in this folder. It's called a **working directory.**

.center[.font80[
"An R project enables your work to be bundled in a portable, self-contained folder. Within the project, all the relevant scripts, data files, figures/outputs, and history are stored in sub-folders and importantly - the working directory is the project’s root folder." - [The Epidemiologist R Handbook](https://epirhandbook.com/en/)]]

You can create a R project folder by File -> New Project -> New Directory. 
