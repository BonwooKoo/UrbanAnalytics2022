...
---
## Functional
Hadley Wickham strongly advocates for *NOT* using loops and advocates functionals, such as **lapply()** or **map()**. 
...
In this course, however, I will try to use loops than functionals. I personally think loops are more intuitive for beginners.
  
If you want to learn more about it, you can read [this](https://adv-r.hadley.nz/fp.html).
