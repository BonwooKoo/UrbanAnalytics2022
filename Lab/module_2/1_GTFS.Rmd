...
Now that our data is ready, we can use various methods to examine whether transit service area is equitably distributed. We will use

1. Drawing scatterplots
2. Correlation Analysis
3. Multiple regression analysis

to evaluate the equity. 

```{r}
# Is there any correlation between SES and service area?
var_name <- as_labeller(c(
...
buffer_by_tract %>% 
  ...
  ggplot() +
  facet_wrap(~variable, scales = "free_y", labeller = var_name) +
