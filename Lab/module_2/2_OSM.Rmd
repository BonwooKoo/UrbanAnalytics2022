...
In the print out, you can see that there are two parts in `net` object: Node Data and Edge Data. Also notice that Node Data is denoted as 'active'. The sfnetworks objects is made of nodes and edges that connect the nodes. When you do data manipulation using, for example, dplyr verbs such as mutate,
